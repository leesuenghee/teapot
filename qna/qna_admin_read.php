        ...
        <div class="qna_check">
          ...
          <div class="admin_aswer_form">
            <div class="reply_admin_section">
              ...
              <!-- if구문 -->
              <?php if($r->reply_st == 0){ ?> <!-- 답변의 상태가 0이라면(답변대기) -->
              ...
              <?php }else if($r->reply_st == 1){ ?> <!-- 답변의 상태가 1이라면(답변완료) -->
                ...
                <div class="reply_status answer_complete">
                  ...
                  <div class="qna_btn d-flex gap-4 justify-content-end">
                    ...
                    <button type="submit" class="modify btn_s" onclick="location.href='qna_modify.php?qidx=<?php echo $r->qidx;?>'">수정</button>
                    <button type="button" class="delete btn_s" onclick="location.href='qna_reply_del.php?qidx=<?php echo $r->qidx;?>'">삭제</button>
                  </div>
                </div>
