...
// MySQL 쿼리 실행
$sql = "INSERT INTO lms_class (cls_title,cls_price,cls_cat,cls_text,regdate,cls_st,thumb_url)
VALUES ('{$cls_tit}','{$cls_pay}','{$cls_cate}', '{$cls_txt}','{$date}','{$cls_paid_str}','{$cls_thumb}')";
// print_r($sql);
