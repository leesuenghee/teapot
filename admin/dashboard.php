          ...
          <form
            ...
            <div class="image-upload p-2">
              <label for="file-input">
                ...
                ?>
                  <img id="profile" src="<?php echo $rs->user_file?>"style="width:95px; hight:95px; border-radius: 50%;" />
                  <?php
                  }
                  ?>
              </label>
        ...
        <table class="table">
          ...
          <?php 
            ...
            ?>
              ...
              <td><button type="button" class="Shortcuts" onclick="location.href='../qna/qna_admin_read.php?qidx=<?php echo $q->qidx;?>'">바로가기</button></td>
            </tr>
            <?php 
              }
            }else{
...
new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [
      {
        label: "월 수익",
        data: [120, 190, 300, 150, 120, 133,120, 190, 300, 150, 120, 133],
        borderWidth: 3,
